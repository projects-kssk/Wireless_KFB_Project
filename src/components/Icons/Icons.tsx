...
/* Generic SVG prop helpers */
interface IconPropsSPS extends React.SVGProps<SVGSVGElement> {}
...
export const RefreshCwIcon: React.FC<IconPropsGeneric> = (props) => (
...
export const CheckCircleIcon: React.FC<IconPropsGeneric> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
