...
export type RedisHealthEffectProps = {
  ...
  redisReadyRef: MutableRefObject<boolean>;
  prevRedisReadyRef: MutableRefObject<boolean | null>;
  redisDropTimerRef: MutableRefObject<number | null>;
  lastRedisDropAtRef: MutableRefObject<number | null>;
...
export const RedisHealthEffect: React.FC<RedisHealthEffectProps> = ({
  serial,
  assumeRedisReady,
  redisDegraded,
  setRedisDegraded,
  ...
  useEffect(() => {
    ...
    rehydrateBlockUntilRef.current = now + 30000;
  ...
  }, [rehydrateOnRecovery, redisDegraded, isScanning, isChecking, suppressLive]);
