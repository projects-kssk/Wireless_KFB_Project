...
type ScannerStatus = { open: boolean; inCooldown: boolean; nextAttemptAt: number; lastError: string | null };
function pickStatus(path: string): ScannerStatus {
  const all = getScannerStatus() as Record<string, ScannerStatus>;
